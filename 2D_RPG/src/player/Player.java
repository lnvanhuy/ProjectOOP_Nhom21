...
public class Player extends Entity {
    ...
    public void setImage() {
        ...
        try {
            // WALKING
            this.entityGraphic.up1 = ImageIO.read(getClass().getResourceAsStream("/res/player/boy_up_1.png"));
            this.entityGraphic.up2 = ImageIO.read(getClass().getResourceAsStream("/res/player/boy_up_2.png"));
            this.entityGraphic.down1 = ImageIO.read(getClass().getResourceAsStream("/res/player/boy_down_1.png"));
            this.entityGraphic.down2 = ImageIO.read(getClass().getResourceAsStream("/res/player/boy_down_2.png"));
            this.entityGraphic.left1 = ImageIO.read(getClass().getResourceAsStream("/res/player/boy_left_1.png"));
            this.entityGraphic.left2 = ImageIO.read(getClass().getResourceAsStream("/res/player/boy_left_2.png"));
            this.entityGraphic.right1 = ImageIO.read(getClass().getResourceAsStream("/res/player/boy_right_1.png"));
            this.entityGraphic.right2 = ImageIO.read(getClass().getResourceAsStream("/res/player/boy_right_2.png"));

            // ATTACKING
            this.entityGraphic.attackUp1 = ImageIO.read(getClass().getResourceAsStream("/res/player/boy_attack_up_1.png"));
            this.entityGraphic.attackUp2 = ImageIO.read(getClass().getResourceAsStream("/res/player/boy_attack_up_2.png"));
            this.entityGraphic.attackDown1 = ImageIO
                    .read(getClass().getResourceAsStream("/res/player/boy_attack_down_1.png"));
            this.entityGraphic.attackDown2 = ImageIO
                    .read(getClass().getResourceAsStream("/res/player/boy_attack_down_2.png"));
            this.entityGraphic.attackLeft1 = ImageIO
                    .read(getClass().getResourceAsStream("/res/player/boy_attack_left_1.png"));
            this.entityGraphic.attackLeft2 = ImageIO
                    .read(getClass().getResourceAsStream("/res/player/boy_attack_left_2.png"));
            this.entityGraphic.attackRight1 = ImageIO
                    .read(getClass().getResourceAsStream("/res/player/boy_attack_right_1.png"));
            this.entityGraphic.attackRight2 = ImageIO
                    .read(getClass().getResourceAsStream("/res/player/boy_attack_right_2.png"));
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
